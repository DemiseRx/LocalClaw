...
const searchEnv = {
  ...env,
  LOCAL_WEB_SEARCH_PORT: process.env.LOCAL_WEB_SEARCH_PORT ?? '8787',
  LOCAL_WEB_SEARCH_HOST: process.env.LOCAL_WEB_SEARCH_HOST ?? '127.0.0.1',
};
const searchProxy = spawn('node', ['scripts/local-web-search-proxy.mjs'], { stdio: 'inherit', shell: true, env: searchEnv });
